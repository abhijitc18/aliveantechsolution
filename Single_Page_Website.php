...
<div class="collapse navbar-collapse text-center" id="navigation">
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item">
      <div class="active">
        <a class="nav-link" style="color: #f96a3f; " href="Website_Development.php">Website Development</a>
      </div>
...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Single Page Website</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Single Page Website</li>
          </ol>
          <br>
          <br>
          <br>
  ...
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Single_Page_Website.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#00b386;  ">Single Page Website</a></li>
            ...
            <li class="border-bottom border-color"><a href="Website_Upgradation.php" class="text-color d-block pb-3 mt-3 text-decoration-none">Website Upgradation</a></li>
      ...
      <div class="col-lg-8">
        ...
        <p class="mb-3" style="text-indent: 0em;"><b>Alivean Tech Solutions </b>will design you a user-friendly and responsive single-page website where you can show all your content and portfolio and save your visitors time.</p>

        <h4 class="mb-4">WHEN TO USE A SINGLE-PAGE WEBSITE ?</h4>
        <p class="mb-3">A single-page website is commonly used for locally-based business or small scale business .In this website you can show your product or services on a single page which makes for visitors very easy to understand about services or products.</p>
        <img src="images/project/SINGLEPAGEWEBSITE.png" alt="service thumb" class="img-fluid-custom img-responsive">
        <h4 class="mb-4">FEATURES OF THE SINGLE-PAGE WEBSITE</h4>
        <p class="mb-3">single-page website designs are great for mobiles, with small numbers of content, the site loads quickly. Also visitors can find services and products clearly and quickly due to clearly-distinguished landing page or layout of the site.</p>

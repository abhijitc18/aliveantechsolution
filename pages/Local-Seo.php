...
<section class="section">
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Local-Seo.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#80bfff ;  "> Local Seo</a></li>
      ...
      <div class="col-lg-8">
        <p class="mb-3" style="text-indent: 0em;">Using our services, your website can show up on Google local search listings on relevant search terms. This will automatically generate more traffic for your site and attract customers from nearby areas or targeted areas.</p>

        <img src="images/project/LOCALSEO.png" alt="service thumb" class="img-fluid-custom img-responsive">

        <!-- <img src="images/service/service11.webp" alt="service thumb" class="img-fluid w-100 mb-5"> -->
        <h4 class="mb-4">Importance Of Local Seo ?</h4>
        <ul class="list-styled style-circle">

          <li class="mb-2">Local SEO increases your website’s rankings in the search results.
          <li class="mb-2">Local SEO results receive the highest conversion rate.</li>
          <li class="mb-2">It helps mobile users easily find your business.</li>
          <li class="mb-2">Local SEO ensures your business is found on Google maps.</li>
          <li class="mb-2">It helps your company increase its local online visibility.</li>
          <li class="mb-2"> Local SEO helps you to outrank your local competitors.</li>
          <li class="mb-2">It helps you to increase organic traffic to your website.</li>
          <li class="mb-2"> Local SEO also helps you to get more suited leads within your specific local area.</li>
        ...
        <ul class="list-styled style-circle">
          ...
          <li class="mb-2"> Local Customer Analysis</li>
          <li class="mb-2">Keyword Research</li>
          <li class="mb-2">Persona Modeling</li>
          <li class="mb-2">Local Competitor Analysis</li>
          <li class="mb-2">Content Optimization</li>
          <li class="mb-2"> In-Depth Analytics</li>

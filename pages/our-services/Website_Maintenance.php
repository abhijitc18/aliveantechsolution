...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3"> Website Maintenance</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page"> Website Maintenance</li>
          </ol>
          <br>
          <br>
          <br>
...
<section class="section">
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Website_Maintenance.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#00b386;">Website Maintenance</a></li>
      ...
      <div class="col-lg-8">
        <p class="mb-3" style="text-indent: 0em;">Maintaining a website is an important task for big and small companies so that the company can retain its customers or visitors .Alivean Tech Solutions not only designs and develops your portals but also maintains them to keep them running smoothly and to protect them from sudden attacks or jinxes.We also manage third-party updates so that your app is always integrated and running smoothly. Our team takes care of security patches, provides insights on hardware updates and even new functionalities.</p>
        <img src="images/project/WEBSITEMAINTENANCE.png" alt="service thumb" class="img-fluid-custom img-responsive">
        <h4 class="mb-4">WE PROVIDE WEBSITE MAINTENANCE FOR:</h4>
        <ul class="list-styled style-circle">
          <li class="mb-2"> Wordpress Website</li>
          <li class="mb-2">Php Website</li>
          <li class="mb-2"> Magento Website</li>
          <li class="mb-2">Codeigniter Website</li>
          <li class="mb-2">Html Website Website</li>
          <li class="mb-2">E-commerce Website</li>
        </ul>
        <h4 class="mb-4">WHAT EXACTLY WE DO IN WEBSITE MAINTENANCE ?</h4>
        <ul class="list-styled style-circle">
          <li class="mb-2"> Bug Fixes and improvements</li>
          <li class="mb-2"> Content Backup</li>
          <li class="mb-2"> Website Speed Or Performance Checkup</li>
          <li class="mb-2"> Hack & Virus protection</li>

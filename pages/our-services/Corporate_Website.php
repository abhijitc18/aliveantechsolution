...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Corporate Website</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Corporate Website</li>
          </ol>
          <br>
          <br>
          <br>
  ...
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Corporate_Website.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#00b386;">Corporate Website</a></li>
      ...
      <div class="col-lg-8">
        ...
        <p class="mb-3" style="text-indent: 0em;">A corporate website development primarily signifies a managed business organization. Every corporate website has several aims and goals. Corporate website developer it needs to grow its business and strengthen its brands through promotions, attract and retain good employees, and also periodically inform investors about its financial and other relevant data. Our team includes talented specialists on the cutting edge of corporate website development Also our team is passionate about building business websites from the ground up and tweaking them for optimized results. Because our corporate web development team knows how to keep you ahead of your competition.</p>
        <img src="images/project/CORPORATEWEBSITE.png" alt="service thumb" class="img-fluid-custom img-responsive">
        ...
        <p class="mb-3">If you want to build a responsive single-page website that represents your business, you should consider Alivean Tech Solutions .We also provide digital marketing services which will help you to reach a much bigger audience, improve awareness, and generate more engagement, traffic, and leads.
          We work 6 days a week, excluding important holidays. Contact us if you have any emergency, with our hotline or contact form.</p>

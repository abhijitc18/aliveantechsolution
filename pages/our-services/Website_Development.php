...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Website Development </h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Website Development </li>
          </ol>
          <br>
          <br>
          <br>
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href="Single_Page_Website.php"><img class="card-img-top rounded-0" src="images/project/SINGLE.png" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-bar-chart"></i>
          <h4><a href="Single_Page_Website.php" class="text-dark"> SINGLE PAGE WEBSITE</a></h4>
          <p class="card-text">We design Single Page Website where you can show all your content and portfolio and save time for your visitors and which is User-Friendly and Responsive.</p>
          <a href="Single_Page_Website.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>
    <!-- service-item -->
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href="Business_Catalogue_Website.php"><img class="card-img-top rounded-0" src="images/project/BUSINESS.png" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-handshake-o"></i>
          <h4><a href="Business_Catalogue_Website.php" class="text-dark"> BUSINESS CATALOGUE WEBSITE</a></h4>
          <p class="card-text">We aims to design and develop the best business catalogue websites. We design you an effective and informative product catalogue that keeps customers on your site.</p>
          <a href="Business_Catalogue_Website.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>
    <!-- service-item -->
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href="Corporate_Website.php"><img class="card-img-top rounded-0" src="images/project/CORPORATE.png" height="349.2" width="494" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-briefcase"></i>
          <h4><a href="Corporate_Website.php" class="text-dark">CORPORATE WEBSITE</a></h4>
          <p class="card-text">At Alivean Tech Solutions, Our team helps corporate companies and big organizations by designing them websites which help them to increase their sales.</p>
          <a href="Corporate_Website.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>
    <!-- service-item -->
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href="Ecommerce_Website.php"><img class="card-img-top rounded-0" src="images/project/E-COMMERCE.png" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-bar-chart"></i>
          <h4><a href="Ecommerce_Website.php" class="text-dark"> E-COMMERCE WEBSITE</a></h4>
          <p class="card-text">We help e-commerce companies to generate ROI faster.</p><br><br>
          <a href="Ecommerce_Website.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href="Website_Upgradation.php"><img class="card-img-top rounded-0" src="images/project/upgradation.jpeg" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-bar-chart"></i>
          <h4><a href="Website_Upgradation.php" class="text-dark"> WEBSITE UPGRADATION</a></h4>
          <p class="card-text">Alivean Tech Solutions offers a fully responsive and high-quality website upgrade services for static sites and dynamic sites.</p><br>
          <a href="Website_Upgradation.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 mb-4 mb-lg-5">
      <div class="card border-0 rounded-0 box-shadow">
        <a href=" Website_Maintenance.php"><img class="card-img-top rounded-0" src="images/project/MAINTENANCE.png" alt="Card image cap"></a>
        <div class="card-body position-relative">
          <i class="card-icon fa fa-bar-chart"></i>
          <h4><a href=" Website_Maintenance.php" class="text-dark"> WEBSITE MAINTENANCE</a></h4>
          <p class="card-text">Our company gives best website maintenance services which helps to improve security and performance of websites.</p><br>
          <a href=" Website_Maintenance.php" class="btn btn-secondary btn-arrow">Read More</a>
        </div>
      </div>
    </div>

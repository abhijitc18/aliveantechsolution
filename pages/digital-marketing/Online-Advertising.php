...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Online Advertising</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Online Advertising</li>
          </ol>
          <br>
          <br>
          <br>
...
<section class="section">
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Online-Advertising.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#80bfff ;  ">Online Advertising</a></li>
      ...
      <div class="col-lg-8">
        <p class="mb-3" style="text-indent: 0em;">Google AdWords is a best medium for reaching out to the target customers on Google at the very right moment. Reach to the audience who is already interested in the product or service you’re offering with our Google Ads management services. Using Google Ads, businesses can get a high return on investment than other marketing strategies.

        </p>
        <img src="images/project/ONLINEADVERTISING.png" alt="service thumb" class="img-fluid-custom img-responsive">


        <!-- <img src="images/service/service11.webp" alt="service thumb" class="img-fluid w-100 mb-5"> -->
        <h4 class="mb-4">How We Do Google Ads ?</h4>
        <ul class="list-styled style-circle">

          <li class="mb-2">Keywords Analysis</li>
          <li class="mb-2">Audience</li>
          <li class="mb-2">Re-targeting</li>
          <li class="mb-2">Campaign Analysis</li>
          <li class="mb-2">ROI Analysis</li>

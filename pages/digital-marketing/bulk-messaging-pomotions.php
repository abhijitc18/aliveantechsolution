...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Email Marketing</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Email Marketing</li>
          </ol>
          <br>
          <br>
          <br>
...
<section class="section">
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Email-Marketing.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#80bfff  ;  ">Email Marketing</a></li>
      ...
      <div class="col-lg-8">
        <p class="mb-3" style="text-indent: 0em;">Email Marketing is one of the most productive approaches to attract new customers and also keep in touch with existing users. Effective marketing emails help to increase sales and leads. Email marketing can be used to build relationships with customers. Email marketing helps to notify your audience or customers about your new services or products.

        </p>
        <p class="mb-3" style="text-indent: 0em;">We provides email marketing service with good text, best media formats and images that give your business a brand essence by considering the importance of building your brand . Alivean Tech Solutions help you to target your customers through the best email marketing services.</p>


        <img src="images/project/EMAILMARKETING.png" alt="service thumb" class="img-fluid-custom img-responsive">
        <!-- <img src="images/service/service11.webp" alt="service thumb" class="img-fluid w-100 mb-5"> -->
        <h4 class="mb-4">Features Of Email Marketing:</h4>
        <ul class="list-styled style-circle">

          <li class="mb-2"> Doing campaign in Email marketing is fast and easy.</li>
          <li class="mb-2"> It increases the brand and credibility of your business.</li>
          <li class="mb-2"> The tracking of email is easy such as we can check how many people viewed emails, how many clicked and hoe many unsubscribed emails.</li>
          <li class="mb-2"> Email marketing boosts sales and the conversion rate is higher.</li>

...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">E-commerce Website</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">E-commerce Website</li>
          </ol>
          <br>
          <br>
          <br>
  ...
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Ecommerce_Website.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#00b386;">E-commerce Website</a></li>
      ...
      <div class="col-lg-8">
        ...
        <p class="mb-3" style="text-indent: 0em;">Now-a –days,E commerce is the latest trend of business . Local businesses are now spreading globally through web hence e-commerce provides most convenient way to handle it easily. If you are planning to make your offline store to an online store then e-commerce site is best where you can sell your products online. We can create a user-friendly and responsive customized e-commerce website for you which can attract a lot many customers and that will help you in your business growth. Online stores are rapidly increasing with a competition to have buyer's attention and Alivean Tech Solutions provides you the best e-commerce website solutions that are secure, easy to use, most sophisticated, feature enriched, attractive and fully responsive.</p>
        <img src="images/project/E-COMMERCEWEBSITE.png" alt="service thumb" class="img-fluid-custom img-responsive">
        ...
        <h5 class="mb-4"> Features Of E-commerce Website Solutions:</h5>
        <ul class="list-styled style-circle">

          <li class="mb-2"> Attractive, appealing, amazing theme</li>
          <li class="mb-2"> Proper filtration for related requirement</li>
          <li class="mb-2"> Payment gateway integration</li>
          <li class="mb-2"> Invoice generation</li>
          <li class="mb-2"> SEO with modern design</li>
          <li class="mb-2"> Secure code and latest web standards</li>
          <li class="mb-2"> Inventory management and online support</li>
          <li class="mb-2">Featured shopping cart</li>

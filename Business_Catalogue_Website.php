...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Business Catalogue Website</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Business Catalogue Website</li>
          </ol>
          <br>
          <br>
          <br>
  ...
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Business_Catalogue_Website.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#00b386;  ">Business Catalogue Website</a></li>
      ...
      <div class="col-lg-8">
        ...
        <p class="mb-3" style="text-indent: 0em;"><b>Alivean Tech Solutions </b> strives to design and develop the best Business Catalogue Websites. We design you an informative and attractive product catalogue to keep your customers engage on your site.The most important key factors of Business Catalogue Websites is that you want to keep engaging to the customer with your products or services and also the customers can easily browse your services. We consider all the micro factors while developing your company’s website.</p>
        <img src="images/project/BUSINESSCATALOGUEWEBSITE.png" alt="service thumb" class="img-fluid-custom img-responsive">

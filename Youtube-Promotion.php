...
<section class="banner-section bg-cover overlay" data-background="images/backgrounds/page-title.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-white mt-3">Youtube Promotion</h2>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent p-0">
            <li class="breadcrumb-item font-weight-semebold"><a class="text-white" href="index.php">Home</a></li>
            <li class="breadcrumb-item font-weight-semebold active text-primary" aria-current="page">Youtube Promotion</li>
          </ol>
          <br>
          <br>
          <br>
...
<section class="section">
  <div class="container">
    <div class="row">
      <aside class="col-lg-4">
        ...
        <div class="bg-white px-4 py-5 box-shadow mb-5">
          ...
          <ul class="list-styled style-circle">
            ...
            <li class="border-bottom border-color"><a href="Youtube-Promotion.php" class="text-color d-block pb-3 mt-3 text-decoration-none" style="color:#80bfff ;  ">Youtube Promotion</a></li>
      ...
      <div class="col-lg-8">
        <p class="mb-3" style="text-indent: 0em;">YouTube Video Marketing Services is the best Experience of the magic of Videos to Boost your Business that allow you to supercharge your video promotion on YouTube to make it a brand among users. outube has a lot of traffic opportunities according to YouTube's research, there are over a billion users, and they watch a billion hours of video per day. YouTube marketing services give your business a great chance to target a huge audience base to showcase your product or services and to get more leads.</p>
        <img src="images/project/YOUTUBEPROMOTION.png" alt="service thumb" class="img-fluid-custom img-responsive">

        <!-- <img src="images/service/service11.webp" alt="service thumb" class="img-fluid w-100 mb-5"> -->
        <h4 class="mb-4">YOUTUBE Marketing Services:</h4>
        <ul class="list-styled style-circle">
          <li class="mb-2"> <b> Audience Targeting</b></li>
          <p class="mb-3" style="text-indent: 5em;">YouTube is the second most visited website. By focusing on creating captivating videos that stand out from what your competitors are doing is helps to reach your audience.</p>
          <li class="mb-2"> <b> Video Optimization</b></li>
          <p class="mb-3" style="text-indent: 5em;">Increasing your videos' views with our best YouTube SEO Services .</p>
          <li class="mb-2"> <b> Video Syndications</b></li>
          <p class="mb-3" style="text-indent: 5em;">We distribute your videos on all video websites as well as on other social media channels so that you can communicate your message to a wider audience. </p>
          <li class="mb-2"><b> Influencer Outreach</b></li>
          <p class="mb-3" style="text-indent: 5em;">Influencer outreach is the strategy of leveraging influencers to promote your brand, product, or service.</p>
